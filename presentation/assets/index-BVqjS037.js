...
`,De=n=>{const a=v.progress.iconSize*2.5,t=v.progress.iconSize*4.5,r=n.numberOfSlides*t+v.progress.iconSize*2,u=(v.width-r)/2,k=v.height-35;return`<g id="progress">
    ${st(n.numberOfSlides).map((B,z)=>lt({x:u+a+z*t,y:k,index:z,isActive:z<=n.slideIndex})).join("")}
  ...
  </g>`,ft=["ssg"],ee=n=>ft.includes(n),E=n=>{let a;return ee(n.env)&&n.transition!="css"&&(a=n.prevSlideId),a},ve=n=>`<circle 
...
concerns or negatives are when using SVGs.`,iconTransformProp:"scale(0.05) translate(1000, 950)"})}
        ...
        `,...t}),...t}},kt=500,K=n=>{const a=E(n.ctx),t=u=>ce(a,kt*u,"end"),r=u=>u==null?"":`
    ...
    <div xmlns="http://www.w3.org/1999/xhtml" style="font-size: 1.33em;">
      ...
      <table>
    ...
    </div>`,k={ssg:{secondsToDisplay:3},notes:await Y(xt)};return{content:()=>A({ctx:n,title:"Animation - CSS or SVG",content:`
        ...
        `,...k}),...k}},fe=n=>{const a=I[n.ctx.themeKey],t=E(n.ctx),r=u=>ce(t,a.defaultDelayInMs*u);return`
    <g opacity="0" transform="translate(${n.x} ${n.y})">
        ...
        ${K({ctx:n,x:1075,y:620,width:0,height:0,animatePosition:4,svgContent:`
            <g class="transition-slide noselect" transform="translate(700 ${z})">
                ${Xe({from:`700 ${z}`,to:`0 ${z}`,begin:a==null?void 0:`${a}-slide-anim.begin+1s`,initialDelay:B})}
              <rect 
                width="500"
                height="180"
                x="190"
        ...
        ${K({ctx:n,x:100,y:520,width:1700,height:450,animatePosition:2,svgContent:`
            <g transform="scale(1.5) translate(850, 50)">
              ...
              <image href="${ee(n.env)?await We(T.entelectGithub):"./assets/img/entelect-github.png"}" clip-path="url(#httpImageClip)" alt="Description of the image" />
            </g>
          `,codeContent:`
            ${t.tag("&lt;svg",m)}
            ${t.keyValue(["version","=",'"1.1"'],m)}
    ...
    />`,be=n=>{const a=I[n.ctx.themeKey],t=E(n.ctx),r=u=>ce(t,a.defaultDelayInMs*u);return`
    <g opacity="0" transform="translate(${n.x} ${n.y})">
        ${H({duration:"1s",begin:r(n.animatePosition-1)})}
        <rect 
          width="500"
...
<foreignObject x="40" y="130" width="500" height="500" clip-path="url(#movieClip)">
  ...
  <svg xmlns="http://www.w3.org/2000/svg" id="theme-selector" width="128" height="128"
    ...
    <g clip-path="url(#theme-toggle-cutout)">
...
</foreignObject>`,Nt="data:text/markdown;base64,",At=async n=>{const a=I[n.themeKey],t=O(a.code),r={ssg:{secondsToDisplay:3},notes:await Y(Nt)};return{content:()=>A({ctx:n,title:"Why is an SVG?",content:`
        ${be({ctx:n,x:100,y:150,animatePosition:1,svgContent:`
            <text x="250" y="75" class="noselect" fill="${a.controlForeground}" text-anchor="middle" font-size="50">
              Scalability
            </text>
      ...
      `,...r}),...r}},Dt="data:text/markdown;base64,IyBOb3cgdGhlIGZ1biBzdHVmZiBiZWdpbnMKCllvdSBhbGwgbG9vayBsaWtlIHlvdSBoYXZlIHNlZW4gYSBnaG9zdAo=",Kt=async n=>{const a={ssg:{secondsToDisplay:3},notes:await Y(Dt)};return{content:()=>A({ctx:n,title:"The Fun begins",content:`
        <g transform="scale(20) translate(33 10)">
          ${Q("ghost")}
        </g>
        `,...a}),...a}},Ot="data:text/markdown;base64,Y2FsZW5kYXJJY29uCg==",Jt=async n=>{const a=I[n.themeKey],t=E(n),r=new Date,u=["January","February","March","April","May","June","July","August","September","October","November","December"],k={ssg:{secondsToDisplay:3},notes:await Y(Ot)};return{content:()=>A({ctx:n,title:"The Fun stuff - Complex icons",content:`
        ...
        `,...k}),...k}},Qt="data:text/markdown;base64,Y2lyY3VsYXJQcm9ncmVzcwo=",qt=async n=>{const a=E(n),t=I[n.themeKey],r=O(t.code);let u=77;ee(n.env)==!1&&(u=Math.round(Math.random()*60)+30);const k="12px",B=70,z=B+20,P=2*3.14*B,G=P*((100-u)/100),U={ssg:{secondsToDisplay:3},notes:await Y(Qt)};return{content:()=>A({ctx:n,title:"The Fun stuff - Custom Indicators",content:`
        ...
        `,...U}),...U}},er="data:text/markdown;base64,ZGlhZ3JhbXMKCiMjIOKWtu+4jyBUaGUgYmVzdCBvciB3b3JzdCB1c2UgZm9yIGFuIFNWRyBpcyBhIHByZXNlbnRhdGlvbgo=",tr=async n=>{const a=E(n),t=I[n.themeKey],r=O({tag:t.d2Code.tag,key:t.d2Code.tag,equals:t.d2Code.equals,value:t.d2Code.equals}),u=O({tag:t.d2Code.key,key:t.d2Code.key,equals:t.d2Code.equals,value:t.d2Code.value}),k={ssg:{secondsToDisplay:3},notes:await Y(er)};return{content:async()=>A({ctx:n,title:"The Fun stuff - Diagrams",content:`
        ...
        `,...k}),...k}},rr="data:text/markdown;base64,Z2l0aHViUHJvZmlsZQo=",ar=async n=>{const a=E(n),t=I[n.themeKey],r={ssg:{secondsToDisplay:3},notes:await Y(rr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Fancy Github profiles",content:`
        ...
        `,...r}),...r}},dr="data:text/markdown;base64,IyBMb2FkZXJzCgotIEVhY2ggb25lIGlzIDEgb3IgMiBrYnMKLSBTYW0gSGVyYmVydCBoYXMgbWFkZSB0aGVzZSBzcGVjaWZpYyBvbmVzIGF2YWlsYWJsZSBmb3IgYXQgbGVhc3QgMTEgeWVhcnMKLSBFYXN5IHRvIGN1c3RvbWlzZSBldGMK",pe=200,nr=async n=>{const a=I[n.themeKey],t=E(n),r="",u={ssg:{secondsToDisplay:3},notes:await Y(dr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Loaders",content:`
          ...
          <g transform="translate(200 300)" fill="${a.controlForeground}" color="${a.controlForeground}">
            ${Ke.map((k,B)=>`
                <g transform="${ir(B)}">
                <rect x="0" y="0" width="${pe+1}" height="${pe+1}" fill="${k.colour}" transform="translate(-${pe/4} -${pe/4})" />
                ${gt(k.id)}
                </g>`).join("")}
              ${r}
          </g>
        ...
        `,...u}),...u}},ir=n=>{const a=n%4,t=Math.floor(n/4);return`translate(${a*pe} ${t*pe})`},or="data:text/markdown;base64,Y2FsZW5kYXJJY29uCg==",ur=async n=>{const a=I[n.themeKey],t=O(a.code),r=E(n),u=(B,z)=>`
    <rect x="50" y="${B}" width="${z}" height="2" rx="5" opacity="0.3"
      fill="${a.cardBackground}" stroke="${a.cardBackground}" stroke-width="3"
    />`,k={ssg:{secondsToDisplay:3},notes:await Y(or)};return{content:async()=>A({ctx:n,title:"The Fun stuff - Meta image / templates",content:`        
        ...
        <g transform="translate(100, 150)">
          ...
          <g transform="translate(225 250)">
            <image id="img-meta-data" x="0" y="0" href="${ee(n.env)?await We(T.metaDataExample):"./assets/img/metaDataExample.png"}" alt="Description of the image" />
            <animateTransform 
              id="image-zoom-anim"
              href="#img-meta-data" 
              attributename="transform"
        ...
        `,...k}),...k}},sr="data:text/markdown;base64,cmFib0xpbmUK",lr=async n=>{const a=E(n),t=I[n.themeKey],r={ssg:{secondsToDisplay:3},notes:await Y(sr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Line animations",content:`
        ...
        `,...r}),...r}},cr="data:text/markdown;base64,c3RhdFBvaW50cwo=",fr=async n=>{const a=I[n.themeKey],t=E(n),r={ssg:{secondsToDisplay:3},notes:await Y(cr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Complex shapes",content:`
        ...
        `,...r}),...r}},gr="data:text/markdown;base64,c3dhdENoYXJ0Cg==",hr=async n=>{const a=E(n),t=I[n.themeKey],r={ssg:{secondsToDisplay:3},notes:await Y(gr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Custom charts",content:`
    ...
    <g id="spinner" ${n.attr??""}>
        ...
        />
    </g>`},yr="data:text/markdown;base64,d2hlZWxPZkZvcnR1bmUK",wr=async n=>{const a=I[n.themeKey],t=E(n),r=["😁","🕹️","🧑‍🎨","💫","🥪"],u={ssg:{secondsToDisplay:3},notes:await Y(yr)};return{content:()=>A({ctx:n,title:"The Fun stuff - Complex shapes",content:`
        ...
        `,...u}),...u}},Ne={"ssg-click.svg":{numLines:8968,numChars:737115,numCharsMinified:719181},"ssg-css.svg":{numLines:8800,numChars:712905,numCharsMinified:695307},"ssg-svg-animation.svg":{numLines:8872,numChars:727640,numCharsMinified:709898}},Qe=(n,a=2)=>{if(!+n)return"0 Bytes";const t=1024,r=a<0?0:a,u=["Bytes","KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"],k=Math.floor(Math.log(n)/Math.log(t));return`${parseFloat((n/Math.pow(t,k)).toFixed(r))} ${u[k]}`},$r=async n=>{const a=E(n),t=I[n.themeKey],r={ssg:{secondsToDisplay:3},notes:""};return{content:()=>A({ctx:n,title:"The end",content:`
          <g opacity="0">
            ${H({duration:"1s",begin:a==null?void 0:`${a}-slide-anim.begin+1s`})}
            <rect 
              width="1100"
  ...
  </g>`,qe=()=>[{id:"slide-intro",slideFunc:yt},{id:"slide-agenda",slideFunc:$t},{id:"slide-what-is-svg",slideFunc:Ht},{id:"slide-why-is-svg",slideFunc:At},{id:"slide-when-use-svg",slideFunc:Rt},{id:"slide-basic-setup",slideFunc:Vt},{id:"slide-basic-drawing",slideFunc:It},{id:"slide-basic-drawing-defs",slideFunc:Zt},{id:"slide-basic-drawing-fakes",slideFunc:Mt},{id:"slide-basic-drawing-css",slideFunc:Ft},{id:"slide-basic-animate",slideFunc:Ct},{id:"slide-advanced-foreign-object",slideFunc:Et},{id:"slide-advanced-security-concerns",slideFunc:Ut},{id:"slide-fun-begins",slideFunc:Kt},{id:"slide-fun-loaders",slideFunc:nr},{id:"slide-fun-circular-progress",slideFunc:qt},{id:"slide-fun-calendar-icon",slideFunc:Jt},{id:"slide-fun-rabobank-line",slideFunc:lr},{id:"slide-fun-github-profile",slideFunc:ar},{id:"slide-fun-stat-points",slideFunc:fr},{id:"slide-fun-meta-image",slideFunc:ur},{id:"slide-fun-wheel-of-fortune",slideFunc:wr},{id:"slide-fun-swat-chart",slideFunc:hr},{id:"slide-fun-diagram",slideFunc:tr},{id:"slide-links",slideFunc:$r}],et=n=>`<g id="background">
    <rect 
  ...
  </g>`,A=async n=>{let a=n.attr??"",t="",r="",u="0",k=ut({ctx:n.ctx,duration:"250ms"}),B="",z="";const P=I[n.ctx.themeKey];if(n.ctx.env=="web",ee(n.ctx.env)){const G=n.ctx,U=G.numberOfSlides-1,R=G.currentSlideIndex>=U;B=De({slideIndex:G.currentSlideIndex,numberOfSlides:G.numberOfSlides}),G.showNotes==!0&&(z=kr(G.id,n.notes));const ie=`
      <animateTransform
        href="#${G.id}"
        attributeName="transform"
        attributeType="XML"
...
`}),xr=(n,a=8)=>`
      ...
      <use href="#p" x="${7*a}" y="${3*a}" fill="${n.illustrationDuckEye}" />`,Cr=n=>{const a=Ge(n.themeKey),t=I[n.themeKey];return`
  <defs>
...
`)})}
  ...
  </svg>`},Ae=async(n,a,t,r)=>{const u=await n.content();return Vr(a,`    
    ${u??""}
    ...
    ${Ir()}
    ${Br(I[a])}
  `)},Sr=n=>{const a=I[n];let t=[X(a,T.kurtLourens,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","kurtLourens"),u.outerHTML)}),X(a,T.standing,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="standing">${u}</g>`}),X(a,T.pitch,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="pitch">${u}</g>`}),X(a,T.about,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","about"),u.outerHTML)}),X(a,T.alien,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="alien">${u}</g>`}),X(a,T.cool,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","cool"),u.outerHTML)}),X(a,T.review,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","review"),u.outerHTML)}),X(a,T.tooltip,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","tooltip"),u.outerHTML)}),X(a,T.qrCode,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="qrCode">${u}</g>`}),X(a,T.undraw,r=>{const u=r.querySelector("g");return u==null?"":(u.setAttribute("id","undraw"),u.outerHTML)}),X(a,T.swatChart,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="swatChart" style="border-radius: 150px;">${u}</g>`}),X(a,T.ghost,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="ghost">${u}</g>`}),X(a,T.facebook,r=>{const u=r.querySelector("g");return u==null?"":(u.removeAttribute("xmlns"),u.outerHTML)}),X(a,T.hacker,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="hacker">${u}</g>`}),X(a,T.kurtGithubHeader,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="kurtGithubHeader">${u}</g>`}),X(a,T.githubHeader,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="githubHeader">${u}</g>`}),X(a,T.webDeveloper,r=>{const u=r?.children?.[0]?.innerHTML??"";return u==null?"":`<g id="webDeveloper">${u}</g>`})];for(const r of Ke)t.push(X(a,`./assets/img/loaders/${r.id}.svg`,u=>{const k=u?.children?.[0]?.innerHTML??"";return k==null?"":`<g id="${r.id}">${k}</g>`}));return Promise.all(t)};var Ze={exports:{}},Te;function Fr(){return Te||(Te=1,function(n){(function(a,t,r){if(!a)return;for(var u={8:"backspace",9:"tab",13:"enter",16:"shift",17:"ctrl",18:"alt",20:"capslock",27:"esc",32:"space",33:"pageup",34:"pagedown",35:"end",36:"home",37:"left",38:"up",39:"right",40:"down",45:"ins",46:"del",91:"meta",93:"meta",224:"meta"},k={106:"*",107:"+",109:"-",110:".",111:"/",186:";",187:"=",188:",",189:"-",190:".",191:"/",192:"`",219:"[",220:"\\",221:"]",222:"'"},B={"~":"`","!":"1","@":"2","#":"3",$:"4","%":"5","^":"6","&":"7","*":"8","(":"9",")":"0",_:"-","+":"=",":":";",'"':"'","<":",",">":".","?":"/","|":"\\"},z={option:"alt",command:"meta",return:"enter",escape:"esc",plus:"+",mod:/Mac|iPod|iPhone|iPad/.test(navigator.platform)?"meta":"ctrl"},P,G=1;G<20;++G)u[111+G]="f"+G;for(G=0;G<=9;++G)u[G+96]=G.toString();function U(o,s,f){if(o.addEventListener){o.addEventListener(s,f,!1);return}o.attachEvent("on"+s,f)}function R(o){if(o.type=="keypress"){var s=String.fromCharCode(o.which);return o.shiftKey||(s=s.toLowerCase()),s}return u[o.which]?u[o.which]:k[o.which]?k[o.which]:String.fromCharCode(o.which).toLowerCase()}function ie(o,s){return o.sort().join(",")===s.sort().join(",")}function D(o){var s=[];return o.shiftKey&&s.push("shift"),o.altKey&&s.push("alt"),o.ctrlKey&&s.push("ctrl"),o.metaKey&&s.push("meta"),s}function oe(o){if(o.preventDefault){o.preventDefault();return}o.returnValue=!1}function te(o){if(o.stopPropagation){o.stopPropagation();return}o.cancelBubble=!0}function ae(o){return o=="shift"||o=="ctrl"||o=="alt"||o=="meta"}function ue(){if(!P){P={};for(var o in u)o>95&&o<112||u.hasOwnProperty(o)&&(P[u[o]]=o)}return P}function J(o,s,f){return f||(f=ue()[o]?"keydown":"keypress"),f=="keypress"&&s.length&&(f="keydown"),f}function re(o){return o==="+"?["+"]:(o=o.replace(/\+{2}/g,"+plus"),o.split("+"))}function e(o,s){var f,l,g,$=[];for(f=re(o),g=0;g<f.length;++g)l=f[g],z[l]&&(l=z[l]),s&&s!="keypress"&&B[l]&&(l=B[l],$.push("shift")),ae(l)&&$.push(l);return s=J(l,$,s),{key:l,modifiers:$,action:s}}function i(o,s){return o===null||o===t?!1:o===s?!0:i(o.parentNode,s)}function d(o){var s=this;if(o=o||t,!(s instanceof d))return new d(o);s.target=o,s._callbacks={},s._directMap={};var f={},l,g=!1,$=!1,p=!1;function h(w){w=w||{};var V=!1,M;for(M in f){if(w[M]){V=!0;continue}f[M]=0}V||(p=!1)}function y(w,V,M,F,Z,N){var L,j,de=[],q=M.type;if(!s._callbacks[w])return[];for(q=="keyup"&&ae(w)&&(V=[w]),L=0;L<s._callbacks[w].length;++L)if(j=s._callbacks[w][L],!(!F&&j.seq&&f[j.seq]!=j.level)&&q==j.action&&(q=="keypress"&&!M.metaKey&&!M.ctrlKey||ie(V,j.modifiers))){var _e=!F&&j.combo==Z,we=F&&j.seq==F&&j.level==N;(_e||we)&&s._callbacks[w].splice(L,1),de.push(j)}return de}function c(w,V,M,F){s.stopCallback(V,V.target||V.srcElement,M,F)||w(V,M)===!1&&(oe(V),te(V))}s._handleKey=function(w,V,M){var F=y(w,V,M),Z,N={},L=0,j=!1;for(Z=0;Z<F.length;++Z)F[Z].seq&&(L=Math.max(L,F[Z].level));for(Z=0;Z<F.length;++Z){if(F[Z].seq){if(F[Z].level!=L)continue;j=!0,N[F[Z].seq]=1,c(F[Z].callback,M,F[Z].combo,F[Z].seq);continue}j||c(F[Z].callback,M,F[Z].combo)}var de=M.type=="keypress"&&$;M.type==p&&!ae(w)&&!de&&h(N),$=j&&M.type=="keydown"};function b(w){typeof w.which!="number"&&(w.which=w.keyCode);var V=R(w);if(V){if(w.type=="keyup"&&g===V){g=!1;return}s.handleKey(V,D(w),w)}}function x(){clearTimeout(l),l=setTimeout(h,1e3)}function C(w,V,M,F){f[w]=0;function Z(q){return function(){p=q,++f[w],x()}}function N(q){c(M,q,w),F!=="keyup"&&(g=R(q)),setTimeout(h,10)}for(var L=0;L<V.length;++L){var j=L+1===V.length,de=j?N:Z(F||e(V[L+1]).action);W(V[L],de,F,w,L)}}function W(w,V,M,F,Z){s._directMap[w+":"+M]=V,w=w.replace(/\s+/g," ");var N=w.split(" "),L;if(N.length>1){C(w,N,V,M);return}L=e(w,M),s._callbacks[L.key]=s._callbacks[L.key]||[],y(L.key,L.modifiers,{type:L.action},F,w,Z),s._callbacks[L.key][F?"unshift":"push"]({callback:V,modifiers:L.modifiers,action:L.action,seq:F,level:Z,combo:w})}s._bindMultiple=function(w,V,M){for(var F=0;F<w.length;++F)W(w[F],V,M)},U(o,"keypress",b),U(o,"keydown",b),U(o,"keyup",b)}d.prototype.bind=function(o,s,f){var l=this;return o=o instanceof Array?o:[o],l._bindMultiple.call(l,o,s,f),l},d.prototype.unbind=function(o,s){var f=this;return f.bind.call(f,o,function(){},s)},d.prototype.trigger=function(o,s){var f=this;return f._directMap[o+":"+s]&&f._directMap[o+":"+s]({},o),f},d.prototype.reset=function(){var o=this;return o._callbacks={},o._directMap={},o},d.prototype.stopCallback=function(o,s){var f=this;if((" "+s.className+" ").indexOf(" mousetrap ")>-1||i(s,f.target))return!1;if("composedPath"in o&&typeof o.composedPath=="function"){var l=o.composedPath()[0];l!==o.target&&(s=l)}return s.tagName=="INPUT"||s.tagName=="SELECT"||s.tagName=="TEXTAREA"||s.isContentEditable},d.prototype.handleKey=function(){var o=this;return o._handleKey.apply(o,arguments)},d.addKeycodes=function(o){for(var s in o)o.hasOwnProperty(s)&&(u[s]=o[s]);P=null},d.init=function(){var o=d(t);for(var s in o)s.charAt(0)!=="_"&&(d[s]=function(f){return function(){return o[f].apply(o,arguments)}}(s))},d.init(),a.Mousetrap=d,n.exports&&(n.exports=d)})(typeof window<"u"?window:null,typeof window<"u"?document:null)}(Ze)),Ze.exports}var $e=Fr();const tt=(n,a)=>[location.origin,location.pathname,a==Be.presenter?`?mode=${a}`:"",`#${n}`].join(""),zr=(n,a)=>{$e.bind(["home","0"],()=>{a(-9999)}),$e.bind(["up","pageup","left"],()=>{a(-1)}),$e.bind(["down","pagedown","right"],()=>{a(1)}),$e.bind("end",()=>{a(9999)}),$e.bind("p",()=>{const t=tt(n(),"presenter");window.open(t,"_blank")})},Zr=(n,a,t,r)=>{const u=Math.min(Math.max(a,0),r);return t!="initial"&&n==u?[n,!0]:isNaN(a)?[0,!1]:a<0?[0,!1]:a>r?[r,!1]:[a,!1]},Lr=n=>{const a=document.querySelector(":root");if(a!=null){for(const t of Object.keys(n)){const r=n[t],u=Oe(t);a.style.setProperty(u,r)}a.style.setProperty("--font-family",v.font)}},Mr=n=>{console.log("window button listener setup"),Le("#window-minimize",()=>{console.log("minimize"),n.tempMinimize()}),Le("#window-maximize",()=>{console.log("maximize"),n.toggleTheme()}),Le("#window-close",()=>{console.log("close")})},Le=(n,a)=>{const t=document.querySelector(n);if(t==null){console.warn(`Button with id "${t}" not found`);return}t.onclick=()=>a(),t.classList.add("pointer")},Wr=()=>{const a=new URLSearchParams(location.search).get("mode")??Be.slides,t=+location?.hash?.replace?.("#","");return{viewMode:a,slideIndex:t}},Pr=(n,a)=>{const t=tt(n,a);location.href!=t&&(location.href=t)},Ee="web",rt="kurt-presentation-theme";let Me=!1,ge=localStorage.getItem(rt)??"dark",ye=0;const Hr={"slide-basic-drawing-defs":"./assets/img/sun-tornado.svg"},jr=async()=>{let{viewMode:n,slideIndex:a}=Wr();const t=document.querySelector("#presentation-container"),r=document.querySelector("#presentation-presenter-container");if(t==null||r==null){console.error("unable to initialise",{containerElem:t,presenterElem:r});return}const u=qe(),k=u.length,B=k-1,{renderFunc:z,broadcastChannel:P}=Rr(t,r,u,k,B,n);P.addEventListener("message",async U=>{const R=U.data;if(R.type==ke.slide){if(a==R.data)return;a=await z(a,R.data,"broadcast")}if(R.type==ke.cursor){if(ye==R.data)return;at(t,R.data)}}),zr(()=>a,async U=>{a=await z(a,a+U,"slide")}),await z(a,a,"initial"),t.classList.add("ready")},Rr=(n,a,t,r,u,k)=>{const B=new BroadcastChannel("KurtLourensSvg"),z=async(P,G,U)=>{const[R,ie]=Zr(P,G,U,u);if(ie==!0)return P;Pr(R,k),U!="broadcast"&&B.postMessage({type:ke.slide,data:R});const D=t[R],te=await(D.slideFunc??(()=>Promise.resolve(vr)))({id:D.id,env:Ee,themeKey:ge,currentSlideIndex:R,numberOfSlides:r}),ae=n.querySelector("svg"),ue=await Ae(te,ge,R,r);if(ae!=null&&(ae.outerHTML=ue),k==Be.slides){const J=document.querySelector("#background-container");if(J!=null){const re=Hr[D.id];if(re!=null){let e=document.createElement("img");e.src=re,e.style="opacity: 0",J.appendChild(e),setTimeout(()=>{e.style=""},1e3)}else J.innerHTML=""}Mr({tempMinimize:()=>{Me?n.classList.remove("minimized"):n.classList.add("minimized"),Me=!Me},toggleTheme:()=>{const re=Object.keys(I),i=(re.indexOf(ge)+1)%re.length;localStorage.setItem(rt,re[i]),document.location.reload()}})}if(k==Be.presenter){n.classList.add(k),a.style.removeProperty("display"),window.setupTimer=g=>{if(console.log("setupTimer"),g==null)return;g.innerHTML="00m 00s";const $=new Date().getTime(),p=setInterval(()=>{g==null&&clearInterval(p);const h=new Date().getTime()-$,y=Math.floor(h%(1e3*60*60)/(1e3*60)),c=Math.floor(h%(1e3*60)/1e3);g.innerHTML=`${String(y).padStart(2,"0")}m ${String(c).padStart(2,"0")}s`},333)};const J=n.querySelector("#cursor-options");if(J!=null){const g=[],$=(p,h)=>`<button class="cursor-btn" onclick="onCursorButtonClick(${p})"><img src="./assets/img/${h}" width="20px" height="20px" /></button>`;for(let p=0;p<se.length;p++){const h=se[p];h!="unset"&&(h=="cursor-red-dot"&&g.push($(p,"red-dot.svg")),h=="cursor-hand"&&g.push($(p,"hand.svg")))}J.innerHTML=g.join(""),window.onCursorButtonClick=function(p){for(const y of se)n.classList.remove(y);ye=p;const h=se[ye];h.includes("cursor-")&&n.classList.add(h),B.postMessage({type:ke.cursor,data:p})}}const i=await(t[R+1].slideFunc??(()=>Promise.resolve(_r("END"))))({id:D.id,env:Ee,themeKey:ge,currentSlideIndex:R,numberOfSlides:r}),d=await Ae(i,ge,R+1,r+1),o=a.querySelector("svg");o!=null&&(o.outerHTML=d);const s=a.querySelector(".notes"),f=te.publicNotes??te.notes,l=ot(f);s!=null&&(s.innerHTML=l)}return R};return n.oncontextmenu=P=>{P?.preventDefault?.();const G=(ye+1)%se.length;at(n,G),B.postMessage({type:ke.cursor,data:G})},{broadcastChannel:B,renderFunc:z}},at=(n,a)=>{for(const r of se)n.classList.remove(r);ye=a;const t=se[ye];t.includes("cursor-")&&n.classList.add(t)};Lr(I[ge]);jr();
