...
Raster image files save the colour information per pixel, so scaling these images only makes the resulting image larger and does add pixels. **Creating a more blurry result**
...
- Because SVGs are text based, their content can be read by screen readers.
