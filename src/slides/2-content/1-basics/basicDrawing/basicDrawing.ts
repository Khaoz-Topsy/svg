    ...
    content: slideBase({
      ...
      content: `
        ...
        ${slideBasicDrawingCard({
          ...
          svgContent: `<line x1="50" y1="200" x2="225" y2="50" stroke="${svgConstants.colour.exampleColour}" stroke-width="5" />`,
          codeContent: `
            ${svgCode.tag('&lt;line')}<br />
            ...
            ${svgCode.keyValue(['stroke', '=', `"${svgConstants.colour.exampleColour}"`], { tabLevel: 1 })}
        ...
        ${slideBasicDrawingCard({
          ...
          animatePosition: 2,
          overrideForeignObjectX: 280,
          svgContent: `<rect x="50" y="60" width="165" height="130" fill="transparent" stroke="${svgConstants.colour.exampleColour}" stroke-width="5" />`,
          codeContent: `
            ${svgCode.tag('&lt;rect')}<br />
            ${svgCode.keyValue(['x', '=', '"50"'], { tabLevel: 1 })}
            ${svgCode.keyValue(['y', '=', '"75"'])}
            ${svgCode.keyValue(['fill', '=', '"transparent"'])}<br />
            ${svgCode.keyValue(['width', '=', '"165"'], { tabLevel: 1 })}
            ${svgCode.keyValue(['height', '=', '"130"'])}<br />
            ${svgCode.keyValue(['stroke', '=', `"${svgConstants.colour.exampleColour}"`], { tabLevel: 1 })}
            ${svgCode.keyValue(['stroke-width', '=', '"5"'])}<br />
            ${svgCode.tag('/&gt;')}
          `,
        ...
        ${slideBasicDrawingCard({
          ...
          animatePosition: 3,
          overrideForeignObjectX: 280,
          svgContent: `<circle cx="150" cy="125" r="80" fill="transparent" stroke="${svgConstants.colour.exampleColour}" stroke-width="5" />`,
          codeContent: `
        ...
        ${slideBasicDrawingCard({
          ...
          svgContent: `<polygon points="130,50 200,110 180,190 80,190 60,110" 
              fill="transparent" stroke="${svgConstants.colour.exampleColour}" stroke-width="5" />`,
          codeContent: `
        ...
        ${slideBasicDrawingCard({
          ...
          svgContent: `<use href="#entelect-logo"
              fill="transparent" stroke="${svgConstants.colour.exampleColour}" stroke-width="5" transform="translate(-170 -230)"  />`,
          codeContent: `
            ${svgCode.tag('&lt;path')}<br />
