...
The foreignObject element allows you to include elements from a different XML namespace within your SVG. In most cases, that means embedding HTML content inside your SVG drawing.
...
## ▶️ One more use case for foreignObject is running JS
