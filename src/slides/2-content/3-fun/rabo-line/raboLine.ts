    ...
    content: () =>
      slideBase({
        ...
        <g id="phone-frame" transform="translate(200 150)">
          <rect x="400" y="100" width="10" height="100" fill="transparent" stroke="${theme.phoneFrameAccent}" stroke-width="2" rx="2" />
          <rect x="400" y="250" width="10" height="75" fill="transparent" stroke="${theme.phoneFrameAccent}" stroke-width="2" rx="2" />

          <rect x="0" y="0" width="400" height="800" fill="transparent" stroke="${theme.phoneFrame}" stroke-width="10" rx="10" />
          <rect x="0" y="8" width="400" height="8" fill="transparent" stroke="${theme.phoneFrame}" stroke-width="10" rx="10" />
          <rect x="0" y="16" width="400" height="8" fill="transparent" stroke="${theme.phoneFrame}" stroke-width="10" />
          <rect x="150" y="12" width="100" height="2" fill="transparent" stroke="${theme.phoneFrameAccent}" stroke-width="2" rx="10" />
          <circle cx="300" cy="12" r="8" fill="${theme.phoneFrameAccent}" stroke="${theme.phoneFrameAccent}" />
          
          <rect x="400" y="100" width="10" height="100" fill="${theme.phoneFrame}" stroke="${theme.phoneFrame}" stroke-width="2" rx="2" />
          <rect x="400" y="250" width="10" height="75" fill="${theme.phoneFrame}" stroke="${theme.phoneFrame}" stroke-width="2" rx="2" />

          <rect x="0" y="792" width="400" height="8" fill="transparent" stroke="${theme.phoneFrame}" stroke-width="10" rx="10" />
          <rect x="0" y="784" width="400" height="8" fill="transparent" stroke="${theme.phoneFrame}" stroke-width="10" />
