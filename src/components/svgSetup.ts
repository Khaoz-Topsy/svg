...
<defs>
  ...
  <pattern id="pattern-for-def-example" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
    <circle cx="10" cy="10" r="10" fill="${svgConstants.colour.exampleColour}" />
  </pattern>
  ...
  <rect id="qrPixel" width="8" height="8"  stroke="${svgConstants.colour.controlForeground}" stroke-width="1" rx="0.5"/>
</defs>
